...
@class SharedEvents, SharedRuntimeQuery<__covariant RowType>, SharedSessionInfo, SharedDatabaseDriverFactory, SharedRuntimeTransacterTransaction, SharedKotlinByteArray, SharedKotlinByteIterator;

@protocol SharedMydbQueries, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedGaugeDatabase, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedRuntimeQueryListener, SharedKotlinIterator;
...
__attribute__((swift_name("GaugeDatabase")))
@protocol SharedGaugeDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedMydbQueries> mydbQueries __attribute__((swift_name("mydbQueries")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GaugeDatabaseCompanion")))
@interface SharedGaugeDatabaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedGaugeDatabase>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
...
@interface SharedEvents : SharedBase
- (instancetype)initWithEventName:(NSString *)eventName eventType:(NSString *)eventType attributes:(NSString * _Nullable)attributes trackedAt:(int64_t)trackedAt sessionId:(int64_t)sessionId __attribute__((swift_name("init(eventName:eventType:attributes:trackedAt:sessionId:)"))) __attribute__((objc_designated_initializer));
...
- (SharedEvents *)doCopyEventName:(NSString *)eventName eventType:(NSString *)eventType attributes:(NSString * _Nullable)attributes trackedAt:(int64_t)trackedAt sessionId:(int64_t)sessionId __attribute__((swift_name("doCopy(eventName:eventType:attributes:trackedAt:sessionId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable attributes __attribute__((swift_name("attributes")));
...
@property (readonly) int64_t sessionId __attribute__((swift_name("sessionId")));
@property (readonly) int64_t trackedAt __attribute__((swift_name("trackedAt")));
@end;

__attribute__((swift_name("MydbQueries")))
@protocol SharedMydbQueries <SharedRuntimeTransacter>
@required
- (void)deleteAll __attribute__((swift_name("deleteAll()")));
- (SharedRuntimeQuery<SharedEvents *> *)filterEventOnSessionIdSessionId:(int64_t)sessionId __attribute__((swift_name("filterEventOnSessionId(sessionId:)")));
- (SharedRuntimeQuery<id> *)filterEventOnSessionIdSessionId:(int64_t)sessionId mapper:(id (^)(NSString *, NSString *, NSString * _Nullable, SharedLong *, SharedLong *))mapper __attribute__((swift_name("filterEventOnSessionId(sessionId:mapper:)")));
- (void)insertEventEventName:(NSString *)eventName eventType:(NSString *)eventType attributes:(NSString * _Nullable)attributes trackedAt:(int64_t)trackedAt sessionId:(int64_t)sessionId __attribute__((swift_name("insertEvent(eventName:eventType:attributes:trackedAt:sessionId:)")));
- (void)insertSessionTrackedAt:(int64_t)trackedAt Id:(SharedLong * _Nullable)Id __attribute__((swift_name("insertSession(trackedAt:Id:)")));
- (SharedRuntimeQuery<SharedEvents *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(NSString *, NSString *, NSString * _Nullable, SharedLong *, SharedLong *))mapper __attribute__((swift_name("selectAll(mapper:)")));
- (SharedRuntimeQuery<SharedSessionInfo *> *)selectSession __attribute__((swift_name("selectSession()")));
- (SharedRuntimeQuery<id> *)selectSessionMapper:(id (^)(SharedLong *, SharedLong *))mapper __attribute__((swift_name("selectSession(mapper:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SessionInfo")))
@interface SharedSessionInfo : SharedBase
- (instancetype)initWithTrackedAt:(int64_t)trackedAt Id:(int64_t)Id __attribute__((swift_name("init(trackedAt:Id:)"))) __attribute__((objc_designated_initializer));
- (int64_t)component1 __attribute__((swift_name("component1()")));
- (int64_t)component2 __attribute__((swift_name("component2()")));
- (SharedSessionInfo *)doCopyTrackedAt:(int64_t)trackedAt Id:(int64_t)Id __attribute__((swift_name("doCopy(trackedAt:Id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
+ (id<SharedGaugeDatabase>)createDbDbDriverFactory:(SharedDatabaseDriverFactory *)dbDriverFactory __attribute__((swift_name("createDb(dbDriverFactory:)")));
@end;
